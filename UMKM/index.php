...
<html>
  <head>
    ...
    <!-- script
    ================================================== -->
    <script src="aset/js/modernizr.js"></script>
  </head>
      ...
      <nav id="header-nav" class="navbar navbar-expand-lg px-3 mb-3">
        <div class="container-fluid">
          <a class="navbar-brand" href="index.html">
            <img src="aset/images/main-logo.png" class="logo">
          </a>
              ...
              <div class="row d-flex align-items-center">
                ...
                <div class="col-md-5">
                  <div class="image-holder">
                    <img src="aset/images/banner-image.png" alt="banner">
                  </div>
                </div>
              </div>
            </div>
        ...
        while ($row = mysqli_fetch_assoc($result)) {
            ...
            <div class="swiper-slide">
              <div class="product-card position-relative">
                <div class="image-holder">
                  <img src="aset/images/' . htmlspecialchars($row['gambar']) . '" alt="product-item" class="img-fluid">
                </div>
                <div class="card-detail d-flex justify-content-between align-items-baseline pt-3">
                  <h3 class="card-title text-uppercase">
                    <a href="#">' . htmlspecialchars($row['nama_produk']) . '</a>
                  </h3>
                  <span class="item-price text-primary">$' . htmlspecialchars($row['harga']) . '</span>
                </div>
              </div>
            </div>';
        }
...
?>
        ...
        <div class="row">
          ...
          <div class="post-grid d-flex flex-wrap justify-content-between">
            <div class="col-lg-4 col-sm-12">
              <div class="card border-none me-3">
                <div class="card-image">
                  <img src="aset/images/post-item1.jpg" alt="" class="img-fluid">
                </div>
              </div>
            ...
            <div class="col-lg-4 col-sm-12">
              <div class="card border-none me-3">
                <div class="card-image">
                  <img src="aset/images/post-item2.jpg" alt="" class="img-fluid">
                </div>
              </div>
              <div class="card-body text-uppercase">
                <div class="card-meta text-muted">
            ...
            <div class="col-lg-4 col-sm-12">
              <div class="card border-none me-3">
                <div class="card-image">
                  <img src="aset/images/post-item3.jpg" alt="" class="img-fluid">
                </div>
              </div>
              <div class="card-body text-uppercase">
                <div class="card-meta text-muted">
          ...
          <div class="d-flex flex-wrap">
            <figure class="instagram-item pe-2">
              <a href="https://templatesjungle.com/" class="image-link position-relative">
                <img src="aset/images/insta-item3.jpg" alt="instagram" class="insta-image">
            ...
            <figure class="instagram-item pe-2">
              <a href="https://templatesjungle.com/" class="image-link position-relative">
                <img src="aset/images/insta-item2.jpg" alt="instagram" class="insta-image">
                <div class="icon-overlay position-absolute d-flex justify-content-center">
                  <svg class="instagram">
                    <use xlink:href="#instagram"></use>
                  </svg>
            ...
            <figure class="instagram-item pe-2">
              <a href="https://templatesjungle.com/" class="image-link position-relative">
                <img src="aset/images/insta-item4.jpg" alt="instagram" class="insta-image">
                <div class="icon-overlay position-absolute d-flex justify-content-center">
                  <svg class="instagram">
                    <use xlink:href="#instagram"></use>
                  </svg>
            ...
            <figure class="instagram-item pe-2">
              <a href="https://templatesjungle.com/" class="image-link position-relative">
                <img src="aset/images/insta-item5.jpg" alt="instagram" class="insta-image">
                <div class="icon-overlay position-absolute d-flex justify-content-center">
                  <svg class="instagram">
                    <use xlink:href="#instagram"></use>
                  </svg>
            ...
            <div class="row d-flex flex-wrap justify-content-between">
              <div class="col-lg-3 col-sm-6 pb-3">
                <div class="footer-menu">
                  <img src="aset/images/main-logo.png" alt="logo">
          ...
          <div class="col-md-4 col-sm-6">
            <div class="Shipping d-flex">
              ...
              <div class="card-wrap ps-2">
                <img src="aset/images/dhl.png" alt="visa">
                <img src="aset/images/shippingcard.png" alt="mastercard">
              </div>
            </div>
          </div>
          <div class="col-md-4 col-sm-6">
            <div class="payment-method d-flex">
              <p>Payment options:</p>
              <div class="card-wrap ps-2">
                <img src="aset/images/visa.jpg" alt="visa">
                <img src="aset/images/mastercard.jpg" alt="mastercard">
                <img src="aset/images/paypal.jpg" alt="paypal">
              </div>
            </div>
          </div>
          <div class="col-md-4 col-sm-6">
    ...
    <script src="aset/js/jquery-1.11.0.min.js"></script>
    <script src="https://cdn.jsdelivr.net/npm/swiper/swiper-bundle.min.js"></script>
    <script type="text/javascript" src="aset/js/bootstrap.bundle.min.js"></script>
    <script type="text/javascript" src="aset/js/plugins.js"></script>
