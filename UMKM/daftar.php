        ...
        <div class="card border-0 shadow-sm rounded-4">
          <div class="card-body p-3 p-md-4 p-xl-5">
            <div class="row">
              <div class="col-12">
                <div class="mb-5">
                  <h2 class="h3">UMKM.COM</h2>
                  <h3 class="fs-6 fw-normal text-secondary m-0">Daftarkan dirimu sebagai penjual</h3>
                </div>
              </div>
            </div>
            <form action="control/auth/daftar.php" method="post" >
              <div class="row gy-3 overflow-hidden">
                <div class="col-12">
                  <div class="form-floating mb-3">
                    <input type="text" class="form-control" name="username" id="lastName" placeholder="Username" required>
                ...
                <div class="col-12">
                  <div class="d-grid">
                    <button class="btn bsb-btn-2xl btn-primary" type="submit" name="simpan">Sign up</button>
                  </div>
                </div>
              </div>
            </form>
